const Introduce = () => {
  return (
    <div className="h-96 w-4/5  bg-emerald-600/50 rounded-lg introduce flex flex-col">
      <div className="m-10">
        ...
        <ol className="m-4">
          <li className="text-xl mt-2">1. 코드 개선을 위해 노력하는 개발자</li>
          {/* <p>
          ...
          <li className="text-xl mt-2">2. 꼼꼼하게 빈틈을 채워나가는 개발자</li>
          {/* <p>
          ...
          <li className="text-xl mt-2">
            3. 한번 시작한 일은 끝까지 완수하기 위해 노력하는 개발자
          </li>
          <li className="text-xl mt-2">
            4. 완벽한 것은 없다고 생각하여 최선을 끌어내기 위해 끝없이 고민하는
            개발자
          </li>
        </ol>
      </div>
