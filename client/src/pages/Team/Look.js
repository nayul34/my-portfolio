    ...
    <div className="w-full flex justify-center">
      <div className="sm:w-4/5 w-full p-3 sm:p-0">
        ...
        <div className="m-3">
          ...
          <p className="text-orange-500 text-md sm:text-lg">
            • 게시물 작성, 조회, 삭제
          </p>
          <div className="flex text-md sm:text-lg">
            <p>• </p>
            <p className="text-orange-500 "> 댓글 작성, 조회, 수정 </p>
            <p>, 삭제</p>
          </div>
          ...
          <p className="text-md sm:text-lg">
            • 필터기능(대여 가능한 것, 좋아요 누른것,내가 작성한 게시물,
            카테고리별)
          </p>
          <p className="text-orange-500 text-md sm:text-lg">
            • 채팅 조회, 작성{" "}
        ...
        <div className="m-3">
          ...
          <p className="mt-2 text-xl font-bold"> - Axios를 이용한 통신 -</p>
          <p>
          ...
          <p className="mt-2 text-xl font-bold"> - 반응형과 웹 내비게이션 -</p>
          <p>
        ...
        <div className="m-3">
          ...
          <p className="mt-2 text-xl font-bold">- AWS(S3)를 이용한 배포 -</p>
          <p>
            S3를 이용하여 배포를 해보았는데 자동으로 빌드/배포가 되게 하지 않아
            매번 build 파일을 업로드 해야하는 불편함이 있었습니다. 다음
            프로젝트를 하게 된다면 CI/CD를 해보고자 합니다.
          </p>
          <p className="mt-2 text-xl font-bold"> - HTML5 'meta'요소 -</p>
          <p>
